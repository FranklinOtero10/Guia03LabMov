...
public class TrabajadorHoraModel extends TrabajadorModel{
    ...
    public TrabajadorHoraModel(String codigo, String nombre, String apellido,
                               int nh, float vh){
    ...
    public String toString() {
        return super.getCodigo() + "\t" + super.getNombre() + " " + super.getApellido() + "\t" + "Trabajador por hora" + "\t$" + super.getTotalPagar();
    }
}
